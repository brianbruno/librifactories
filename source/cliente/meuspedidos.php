...
<body>
    ...
    <? require('source/empresa/templates/header.php'); ?>
        ...
        <div class="container">
            ...
            <div class="col s12" id="pedidos">
                <div class="item noSelect primeiro esquerda" onclick="toggleDI(1);" id="i1">
                    <div class="descricao">
                        <span class="nome">Pedido #00042</span><br> Situação: Entregue<br> Data: 01/04/2017<br> Valor: R$50,00
                    </div>
                </div>
                <div class="detalhes-item" id="dI1">
                    ...
                    <div class="opcoesProduto">
                        <a onclick="aparecerAreaContato();" class="waves-effect waves-light btn"><i class="material-icons left">chat</i>Entrar em contato</a>
                    </div>
                ...
                <div class="item noSelect primeiro direita" onclick="toggleDI(2);" id="i2">
                    <div class="descricao">
                        <span class="nome">Pedido #02235</span><br> Situação: Preparando estoque<br> Data: 01/04/2017<br> Valor: R$500,00
                    </div>
                </div>
                <div class="detalhes-item" id="dI2">
                    ...
                    <div class="opcoesProduto">
                        <a onclick="aparecerAreaContato();" class="waves-effect waves-light btn red darken-4 modal-trigger" href="#modal1"><i class="material-icons left">cancel</i>Cancelar pedido</a>
                        <a onclick="aparecerAreaContato();" class="waves-effect waves-light btn"><i class="material-icons left">chat</i>Entrar em contato</a>
                    </div>
                ...
                <div class="item noSelect esquerda" onclick="toggleDI(3);" id="i3">
                    <div class="descricao">
                        <span class="nome">Pedido #03395</span><br> Situação: Na fila para produção<br> Data: 01/04/2017<br> Valor: R$5000,00
                    </div>
                </div>
                ...
                <div class="item noSelect direita" onclick="toggleDI(4);" id="i4">
                    <div class="descricao">
                        <span class="nome">Pedido #04242</span><br> Situação: Em produção<br> Data: 01/04/2017<br> Valor: R$50000,00
                    </div>
                </div>
                <div class="detalhes-item" id="dI4">
                    ...
                    <div class="opcoesProduto">
                        <a onclick="aparecerAreaContato();" class="waves-effect waves-light btn" onclick="$('#modCancelar').show('slow'); setTimeout(function(){$('.container').toggleClass('inativo');},100);"><i class="material-icons left">chat</i>Entrar em contato</a>
                    </div>

                </div>
                <div class="item noSelect esquerda" onclick="toggleDI(5);" id="i5">
                    <div class="descricao">
                        <span class="nome">Pedido #15260</span><br> Situação: Na transportadora<br> Data: 01/04/2017<br> Valor: R$500000,00
                    </div>
                </div>
                ...
                <div class="item noSelect direita" onclick="toggleDI(6);" id="i6">
                    <div class="descricao">
                        <span class="nome">Pedido #15682</span><br> Situação: Na transportadora<br> Data: 01/04/2017<br> Valor: R$5000000,00
                    </div>
                </div>
                ...
                <div class="item noSelect ultimo esquerda" onclick="toggleDI(7);" id="i7">
                    <div class="descricao">
                        <span class="nome">Pedido #22277</span><br> Situação: Na transportadora<br> Data: 01/04/2017<br> Valor: R$50000000,00
                    </div>
                </div>
                ...
                <div class="item noSelect ultimo direita" onclick="toggleDI(8);" id="i8">
                    <div class="descricao">
                        <span class="nome">Pedido #28822</span><br> Situação: Na transportadora<br> Data: 01/04/2017<br> Valor: R$500000000,00
                    </div>
                </div>
        ...
        <script>
            ...
            function aparecerAreaMensagem(){
            $("#contatoComEmpresa").fadeOut("slow");
            $("#contatoMensagem").fadeIn("slow");
            }
            
            function enviandoMensagem(){  
            $("#imgok").fadeIn(200);
            setTimeout(trocaDeImagem, 2000);
            }
                ...
                <div class="col s12 m6 divX">
                    <div class="card white darken-1">
                        ...
                        <div class="card-action">
                            <a style="display: block;" onclick="enviandoMensagem();" class="waves-effect waves-light btn modal-action modal-close">Enviar mensagem</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="modal1" class="modal">
            ...
            <p>Tem certeza de que deseja cancelar o pedido?
                <p>
