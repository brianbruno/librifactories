...
function toggleDI(n){  
	if (document.getElementsByClassName("detalhes-item")[n-1].style.opacity == 0) {
        ...
        setTimeout(function(){
            ...
            document.getElementsByClassName("preloader-wrapper")[n-1].style.opacity = "1"; //Mostrar carregamento
        }, 250);
        setTimeout(function(){
            document.getElementsByClassName("detalhes-item")[n-1].style.opacity = "1"; //Tornar Div totalmente visível
            document.getElementsByClassName("preloader-wrapper")[n-1].style.opacity = "0"; //Esconder carregamento
